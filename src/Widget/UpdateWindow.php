...
class UpdateWindow extends Window
{
    ...
    protected function init(): void
    {
        ...
        $this->form = new Form([
            'id'     => 'update-form', // => gm-mp-mmanager-update-form
            'router' => [
                'route' => $this->route,
        ...
        $this->ui        = 'light';
        $this->cls       = 'gm-mp-mmanager-update';
    ...
    public function renderSteps(): array
    {
        ...
        foreach ($this->steps as $step) {
            ...
            $html .= '<div class="gm-mp-mmanager-update__step' . $active .'"><i class="fal fa-check"></i> ' . $title . '</div>';
        }
        return [
            'xtype' => 'container',
            'cls'   => 'gm-mp-mmanager-update__steps',
            'html'  => $html
        ];
    }
    ...
    public function renderFormItems(): array
    {
        return [
            ...
            [
                'xtype' => 'container',
                'cls'   => 'gm-mp-mmanager-update__notice',
                'html'  => '#{update.notice}'
            ],
            [
                'xtype' => 'hidden',
